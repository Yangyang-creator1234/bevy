...
fn main() {
    App::new()
        ...
        .add_plugins((
            ...
            Material2dPlugin::<MyTestCustomMaterial>::default(),
        ))
...
fn setup(
    ...
    mut materials: ResMut<Assets<MyTestCustomMaterial>>,
) {
    let mesh = asset_server.load("models/barycentric/barycentric.gltf#Mesh0/Primitive0");
    commands.spawn(MaterialMesh2dBundle {
        mesh: Mesh2dHandle(mesh),
        material: materials.add(MyTestCustomMaterial {}),
...
struct MyTestCustomMaterial {}

impl Material2d for MyTestCustomMaterial {
